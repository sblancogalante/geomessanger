	...
	public CreateUser() {
			...
			gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup()
					...
					.addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
						.addComponent(titlePanel, GroupLayout.DEFAULT_SIZE, 584, Short.MAX_VALUE)
						.addGroup(gl_contentPanel.createSequentialGroup()
							.addGap(7)
		...
		gl_contentPanel.setVerticalGroup(
			gl_contentPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPanel.createSequentialGroup()
					.addContainerGap()
					.addComponent(titlePanel, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE)
		...
		createUserButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				EmployeeVO oEmployee = new EmployeeVO(1, documentText.getText(), nameText.getText(),
		...
		gl_panel_4.setHorizontalGroup(
			gl_panel_4.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_4.createSequentialGroup()
					.addGap(15)
					.addComponent(createUserButton, GroupLayout.PREFERRED_SIZE, 127, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED, 228, Short.MAX_VALUE)
					.addComponent(cancelButton, GroupLayout.PREFERRED_SIZE, 127, GroupLayout.PREFERRED_SIZE)
					.addGap(24))
		);
			...
			gl_panel_4.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panel_4.createSequentialGroup()
					...
					.addGroup(gl_panel_4.createParallelGroup(Alignment.BASELINE)
						.addComponent(createUserButton, GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE)
		...
		JLabel obligatoryFieldLabel = new JLabel("<<NOTE: The fields with (*) are obligatory.>>");
		...
		gl_panel_2.setHorizontalGroup(
			gl_panel_2.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(Alignment.LEADING, gl_panel_2.createSequentialGroup()
					...
					.addGap(18)
					.addComponent(isAdmin, GroupLayout.PREFERRED_SIZE, 105, GroupLayout.PREFERRED_SIZE)
			...
			gl_panel_2.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_2.createSequentialGroup()
					...
					.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblTypeOfDocument)
						.addComponent(isAdmin, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
			...
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_1.createSequentialGroup()
							.addGap(6)
							.addComponent(addLoactionButton)))
				...
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGap(18)
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addComponent(repeatPasswordText, GroupLayout.DEFAULT_SIZE, 337, Short.MAX_VALUE)
						.addComponent(passwordText, GroupLayout.DEFAULT_SIZE, 337, Short.MAX_VALUE)
