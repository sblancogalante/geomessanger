...
CREATE TABLE `TextMessages` (
	...
	FOREIGN KEY (`employeeSenderID`) REFERENCES `Employees`(`employeeID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
	FOREIGN KEY (`employeeReceiverID`) REFERENCES `Employees`(`employeeID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
